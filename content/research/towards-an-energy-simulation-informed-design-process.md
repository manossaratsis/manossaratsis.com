...
![Figure 1](towards-an-energy-simulation-informed-design-process/fig1.jpg){: .figure}
*Figure 1: Typological matrix and the results of phase 1*{: .caption}

![Figure 2](towards-an-energy-simulation-informed-design-process/fig2.jpg){: .figure}
...
![Figure 3](towards-an-energy-simulation-informed-design-process/fig3.jpg){: .figure}
...
![Figure 4](towards-an-energy-simulation-informed-design-process/fig4.jpg){: .figure}
*Figure 4: Spatial configuration of laboratory and office work areas*{: .caption}

![Figure 5](towards-an-energy-simulation-informed-design-process/fig5.jpg){: .figure}
...
![Formula 1](towards-an-energy-simulation-informed-design-process/for1.jpg){: .figure}
...
![Figure 6](towards-an-energy-simulation-informed-design-process/fig6.jpg){: .figure}
*Figure 6: Perimeter energy use intensity reduction*{: .caption}

![Figure 7](towards-an-energy-simulation-informed-design-process/fig7.jpg){: .figure}
...
![Figure 8](towards-an-energy-simulation-informed-design-process/fig8.jpg){: .figure}
...
![Figure 9](towards-an-energy-simulation-informed-design-process/fig9.jpg){: .figure}
...
![Figure 10](towards-an-energy-simulation-informed-design-process/fig10.jpg){: .figure}
*Figure 10: Shading fin study to reduce daylight oversupply near the perimeter*{: .caption}

![Figure 11](towards-an-energy-simulation-informed-design-process/fig11.jpg){: .figure}
...
![Figure 12](towards-an-energy-simulation-informed-design-process/fig12.jpg){: .figure}
*Figure 12: Exterior rendering*{: .caption}

![Figure 13](towards-an-energy-simulation-informed-design-process/fig13.jpg){: .figure}
