...
> The study is unique in that the first author is the energy modeler and the architect in charge for the project.
...
![Figure 1](figures/fig1.jpg) *Figure 1: Typological matrix and the results of phase 1*

![Figure 2](figures/fig1.jpg) *Figure 2: Final massing design*
...
![Figure 3](figures/fig3.jpg) *Figure 3: Parametric model build-up*
...
For the first evaluation area, the design challenge was the economical and functional placement of the circulation, lab and office spaces. Two layout variants were tested [Fig. 4]. ![Figure 4](figures/fig4.jpg) *Figure 4: Spatial configuration of laboratory and office work areas*

![Figure 5](figures/fig5.jpg) *Figure 5: Conceptual build-up of the typical floor-plan; circulation in gray and core locations in black*
